...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    image: '/media/SonyHeadphones/Headphones_1.png',
    ...
    video:  '/media/SonyHeadphones/SonyVizVideo.mp4',
    gallery: [
      '/media/SonyHeadphones/Headphones_1.png',
      '/media/SonyHeadphones/Headphones_2.png',
      '/media/SonyHeadphones/SonyHeadphones.mp4',
  ...
  },
  {
    ...
    image: '/media/Crosley turntable/Vinyl2.png',
    ...
    video: '/media/Crosley turntable/Vinyl.mp4',
    gallery: [
      '/media/Crosley turntable/Vinyl1.png',
      '/media/Crosley turntable/Vinyl2.png',
      '/media/Crosley turntable/Vinyl3.png',
      '/media/Crosley turntable/Turntable_1.png',
    ]
  },
    {
    id: 4,
    ...
    categories: ['Lighting'],
    image: '/media/Pastry Contest/Pastry_1.png',
    ...
    gallery: [
      '/media/Pastry Contest/Pastry_1.png',
      '/media/Pastry Contest/Pastry_2.png',
      '/media/Pastry Contest/Pastry_wireframe.png',
      '/media/Pastry Contest/Pastry_3.png'
    ]
  },
  {
    id: 5,
    ...
    categories: ['Lighting'],
    image: '/media/Lipstick and lighter/Fire_1.png',
    ...
    video: '/media/Lipstick and lighter/Fire_2.mp4',
    gallery: [
      '/media/Lipstick and lighter/Fire_1.png',
      '/media/Lipstick and lighter/Fire_3.jpg',
      '/media/Lipstick and lighter/Fire_4.png'
    ]
  },
    {
    id: 6,
    title: 'Chanel N°5',
    categories: ['Lighting'],
    image: '/media/Chanel no5/Chanel_1.png',
    ...
    gallery: [
      '/media/Chanel no5/Chanel_1.png',
      '/media/Chanel no5/Chanel_2.png',
      '/media/Chanel no5/Chanel_3.png'
    ]
  },
  {
    id: 7,
    ...
    image: '/media/Rotational Motion Study/Spinny_2.png',
    ...
    video: '/media/Rotational Motion Study/Spinny_1.mp4',
    gallery: [
      '/media/Rotational Motion Study/Spinny_2.png',
      '/media/Rotational Motion Study/Spinny_3.png'
    ]
  },
{ 
    id: 8, 
    ...
    image: '/media/High heel/Heel_1.jpg', 
    ...
    gallery: [
      '/media/High heel/Heel_2.jpg',
      '/media/High heel/Heel_1.jpg',
      '/media/High heel/Heel_3.jpg'
    ]
  },
  {
    id: 9,
    ...
    categories: ['Modeling'],
    image: '/media/Impala Rollerskate/Rollerskate_1.png',
    ...
    gallery: [
      '/media/Impala Rollerskate/Rollerskate_1.png',
      '/media/Impala Rollerskate/Rollerskate_2.png',
      '/media/Impala Rollerskate/Rollerskate_3.png',
      '/media/Impala Rollerskate/Rollerskate_4.png'
    ]
  },
];